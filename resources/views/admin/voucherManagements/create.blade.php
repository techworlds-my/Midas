...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.voucherManagement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.voucher-managements.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="vouchercode">{{ trans('cruds.voucherManagement.fields.vouchercode') }}</label>
                <input class="form-control {{ $errors->has('vouchercode') ? 'is-invalid' : '' }}" type="text" name="vouchercode" id="vouchercode" value="{{ old('vouchercode', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('limit_item') ? 'is-invalid' : '' }}" type="number" name="limit_item" id="limit_item" value="{{ old('limit_item', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('redeem_point') ? 'is-invalid' : '' }}" type="text" name="redeem_point" id="redeem_point" value="{{ old('redeem_point', '') }}">
