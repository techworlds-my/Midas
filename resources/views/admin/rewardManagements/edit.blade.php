...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.rewardManagement.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.reward-managements.update", [$rewardManagement->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('category') ? 'is-invalid' : '' }}" name="category_id" id="category_id" required>
                    @foreach($categories as $id => $category)
                        <option value="{{ $id }}" {{ (old('category_id') ? old('category_id') : $rewardManagement->category->id ?? '') == $id ? 'selected' : '' }}>{{ $category }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('expired') ? 'is-invalid' : '' }}" type="text" name="expired" id="expired" value="{{ old('expired', $rewardManagement->expired) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $rewardManagement->title) }}" required>
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('top_up_amount') ? 'is-invalid' : '' }}" type="number" name="top_up_amount" id="top_up_amount" value="{{ old('top_up_amount', $rewardManagement->top_up_amount) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('purchase_amount') ? 'is-invalid' : '' }}" type="number" name="purchase_amount" id="purchase_amount" value="{{ old('purchase_amount', $rewardManagement->purchase_amount) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('referral_amount') ? 'is-invalid' : '' }}" type="text" name="referral_amount" id="referral_amount" value="{{ old('referral_amount', $rewardManagement->referral_amount) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bonus') ? 'is-invalid' : '' }}" type="number" name="bonus" id="bonus" value="{{ old('bonus', $rewardManagement->bonus) }}" step="1">
                @if($errors->has('bonus'))
                    <div class="invalid-feedback">
                        {{ $errors->first('bonus') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('point') ? 'is-invalid' : '' }}" type="text" name="point" id="point" value="{{ old('point', $rewardManagement->point) }}">
                @if($errors->has('point'))
                    <div class="invalid-feedback">
                        {{ $errors->first('point') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('voucher') ? 'is-invalid' : '' }}" type="text" name="voucher" id="voucher" value="{{ old('voucher', $rewardManagement->voucher) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('merchant') ? 'is-invalid' : '' }}" type="text" name="merchant" id="merchant" value="{{ old('merchant', $rewardManagement->merchant) }}">
